...
import {PointGeometrical, ObjectTimeSeries} from "../../../../utils/types/plotData"
import xAxisBase from "../../axes/axis/xAxis/xAxisBase";
import {DataRange} from "../../../../utils/types/display";

export default class HistogramObjectTimeSeries extends HistogramBase<ObjectTimeSeries> {
	public constructor(
	...
	public pointAt(i: number): PointGeometrical {
		return [i + 0.55, this.global.data[i][this.value_field as string]]
	}
